...
const repeatedNumberMeanings: { [key: string]: string } = {
    ...
    "3_1": "You have a good creative brain with an excellent memory. You are down to earth in your approach towards life and have a positive mindset in achieving any task or goal. You keep inspiring others with your honesty & optimism. You are totally focused on your growth and your goals. You find it difficult to deal with competitions, and you may experience stress and hurt if this is your only number 3.",
