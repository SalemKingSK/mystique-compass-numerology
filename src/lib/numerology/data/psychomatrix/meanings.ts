...
It must be noted that after giving birth, any woman will experience a depletion of her energy reserves; this inevitably leads to a shift in her interests and goals, meaning that her passion for complex academic disciplines may wane—regardless of whether or not her husband actively supports her personal development. I believe it is precisely for this purely physiological reason that men generally have a greater opportunity to fully realize their potential than women do. Thus, I offer but one piece of advice to the ladies: do not delay—make haste.`
  ...
  4: [
    ...
    { count: 1, label: 'Average health', verbatim: 'Single 4: Baseline health constitution. Requires regular maintenance.', scale: 'very-weak' },
    { count: 2, label: 'Strong body', verbatim: 'Double 4: Robust health and physical strength. Suited for sports.', scale: 'norm' },
    { count: 3, label: 'Excellent health', verbatim: 'Triple 4: Exceptional physical reserves and endurance.', scale: 'special' },
    { count: 4, label: 'Superior physical', verbatim: 'Quadruple 4: Professional athlete profile. Extremely strong constitution.', scale: 'strong' }
  ],
  5: [
    { count: 0, label: 'Dreamer', verbatim: 'Absent: Does not rely on logic. Lives in the clouds, building castles in the air.', scale: 'absent' },
    { count: 1, label: 'Weak logic', verbatim: 'Single 5: Basic logical ability but often superseded by dreams or intuition.', scale: 'very-weak' },
    { count: 2, label: 'Strong logic', verbatim: 'Double 5: Analytical mind. Capable of complex planning and strategic foresight.', scale: 'norm' },
    { count: 3, label: 'Clear-knowing', verbatim: 'Triple 5: Logic so strong it manifests as sudden intuitive insight.', scale: 'special' },
    { count: 4, label: 'Prophet/Strategist', verbatim: 'Quadruple 5: Extreme logical depth. Capable of total foresight.', scale: 'strong' }
  ],
  6: [
