...
const INTER_333_AND_MORE = `The "333" Interest Profile
...
A word of advice is in order: they must not allow their goals and aspirations to be reduced to trivial, mundane concerns. Their potential transcends the boundaries of what is currently conceivable; indeed, there exist no individuals—nor any specialized committees—capable of rendering a truly accurate assessment of their extraordinary abilities. Their only limitation lies within themselves; only laziness or a manifestation into oblivion—whether through alcohol or drugs—can hinder them from realizing their full potential.
...
spiritual diagonal, "1, 5, 9".`,
  ...
  3: {
    ...
    meanings: [
      ...
      { count: 3, label: 'The "333" Interest Profile', verbatim: INTER_333_AND_MORE, scale: 'special' },
      { count: 4, label: 'The "3333 or More" Interest', verbatim: INTER_333_AND_MORE, scale: 'strong' },
      { count: 5, label: 'The "3333 or More" Interest', verbatim: INTER_333_AND_MORE, scale: 'dominant' },
      { count: 6, label: 'The "3333 or More" Interest', verbatim: INTER_333_AND_MORE, scale: 'overload' }
    ]
  },
  4: {
    digit: 4,
...
It is necessary to develop and improve your memory from early childhood, when unique, natural characteristics are present. In early childhood, memory is figurative, "pictorial," based on many receptors for perceiving the surrounding world.`,
    ...
    meanings: [
      ...
      { count: 5, label: 'Erudite but Tough, Merciless', verbatim: `People are erudite, but tough, merciless. Everything that is happening around is clear to them. They clearly see the causes and consequences of events. They possess what can only be called clairvoyance. This combination is quite rare. Such people can predict destinies. They would be quite good in control of economies, as the possibility of their mistakes is very small.`, scale: 'dominant' },
      { count: 6, label: 'Erudite but Tough, Merciless', verbatim: `People are erudite, but tough, merciless. Everything that is happening around is clear to them. They clearly see the causes and consequences of events. They possess what can only be called clairvoyance. This combination is quite rare. Such people can predict destinies. They would be quite good in control of economies, as the possibility of their mistakes is very small.`, scale: 'overload' }
    ]
  }
};
...
// COMPLEMENTARY INSIGHTS TYPE (Internal)
export interface ComplementaryInsight {
  digits: number[];
  title: string;
  insight: string;
