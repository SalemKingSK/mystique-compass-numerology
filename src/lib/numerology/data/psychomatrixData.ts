...
export const PSYCHOMATRIX_CELL_MEANINGS: Record<number, PsychomatrixCellData> = {
  ...
  2: {
    ...
    meanings: [
      ...
      { count: 5, label: 'Extreme Donor Overload', verbatim: 'Five 2\'s represents a profound overload of the donor quality. Energy floods outward in ways the person cannot fully contain. Indifference to personal matters increases; the person gives freely but struggles to protect their own reserves. The risk of energy depletion through others\' crises is high. Physical and creative outlets are essential safety valves.', scale: 'dominant' },
      { count: 6, label: 'Energy Overload Inversion', verbatim: 'Six or more 2\'s triggers the overload inversion: the quality begin to transform into its opposite. The person who should be a radiant donor becomes withdrawn, lethargic, and emotionally flat. Deep fatigue and existential indifference characterize this state. Urgent need for service roles or creative channels to convert this reservoir into output.', scale: 'overload' }
    ]
  },
  3: {
    digit: 3,
    ...
    meanings: [
      ...
      { count: 5, label: 'Obsessive Technical Focus', verbatim: 'Five 3\'s represents an almost total absorption of conscious life by one area of technical or scientific fascination. This can produce genius-level output in a narrow domain while leaving relationships and bodily needs neglected.', scale: 'dominant' },
      { count: 6, label: 'Interest Overload — Fragmentation', verbatim: 'Six or more 3\'s triggers the overload inversion: the person becomes fragmented and scattered across too many simultaneous fascinations. Mastery is rarely reached due to diffusion.', scale: 'overload' }
    ]
  },
  4: {
    digit: 4,
  ...
  5: {
    ...
    meanings: [
      ...
      { count: 4, label: 'Prophetic Logic', verbatim: 'Four or more 5\'s: this person can be called a prophet. Such people are almost never mistaken about their predictions. They can predict destinies. The horizon of logical vision is so large that the person naturally perceives patterns across time — not as mysticism but as pattern-recognition elevated to a near-supernatural acuity. The family line fully absorbs this energy.', scale: 'strong' },
      { count: 5, label: 'Logic Dominates All', verbatim: 'Five 5\'s represents logic that has overwhelmed all other modes of being. Everything is analyzed; emotion, intuition, and spontaneity are absorbed into the analytical framework. The person is a supreme strategist but may find joy and presence nearly inaccessible.', scale: 'dominant' },
      { count: 6, label: 'Logic Overload — Paralysis', verbatim: 'Six or more 5\'s triggers logic overload: the analytical capacity turns against itself. The person becomes paralyzed by over-analysis, unable to reach a decision because every decision generates an infinite regress of consequences to calculate.', scale: 'overload' }
    ]
  },
  6: {
    digit: 6,
  ...
  7: {
    ...
    meanings: [
      ...
      { count: 5, label: 'Divine Mark', verbatim: "Five 7's represents the most extreme positive expression of nature's intent — a person whose entire existence is saturated with divine assignment.", scale: 'dominant' },
      { count: 6, label: 'Luck Overload - Cosmic Burden', verbatim: "Six or more 7's represents the overload of divine assignment. The protection of nature becomes a kind of crushing weight.", scale: 'overload' }
    ]
  },
  8: {
    digit: 8,
    ...
    meanings: [
      { count: 0, label: 'No Sense of Duty to Relatives', scale: 'absent', verbatim: 'A person who does not have eights should not be relied on if he is entrusted with something — he is in no hurry to give back. There is no innate sense of duty to relatives. Such a person may be unreliable in family commitments. However, this quality can be developed through conscious effort.' },
      { count: 1, label: 'Very Weak Sense of Duty', scale: 'very-weak', verbatim: 'The presence of one eight in the psychomatrix begins to strongly influence the character of a person, because there is a possibility of transition of 11 to 8 or, vice versa, of 8 to 11, which is more important. For example, if a person has the character 111 and there is one 8, a new chain of transitions emerges: 111 and 8 transitions to 1 and 88 (kind and tolerant), but with pressure this person explodes and his character transitions into 11111, which is the character of a despot, and a new wave of conflict can take on a very extreme form.' },
      { count: 2, label: 'Duty/Tolerance Given in Norm; Self-Sacrifice', scale: 'norm', verbatim: 'For those capable of self-sacrifice. Two eights represent duty and tolerance given in normal measure. These people are less likely to break the bonds of marriage, although this is not excluded. The balance between duty to others and personal boundaries is healthy.' },
      { count: 3, label: 'Strong Sense of Duty; Truth Finder', scale: 'special', verbatim: "It is necessary to highlight the characteristic of duty for '888'. If you remember, three figures always caused instability of the quality. In this case we deal with the person who is kind, tolerant, remembers parents, but thus becomes the truth finder. This aim can be dangerous if it grows to maximum. Truth finders can even kill without any hesitation for what they think is right. So never play with this part of the person. And for those who got this sign — try to lower your unreasonable demands. Active collectivists who owe everything to everyone." },
      { count: 4, label: 'Very Rare; Parapsychic Abilities', scale: 'strong', verbatim: 'A very rare sign. In the current century, this was only possible for those born in 1988. Children born with this sign had developed abilities and a penchant for studying the exact sciences. Such people often have parapsychic or extrasensory abilities. Four eights dominate and may suppress other qualities.' },
      { count: 5, label: 'Very Rare; Parapsychic Abilities', scale: 'dominant', verbatim: 'A very rare sign. In the current century, this was only possible for those born in 1988. Children born with this sign had developed abilities and a penchant for studying the exact sciences. Such people often have parapsychic or extrasensory abilities. Four eights dominate and may suppress other qualities.' },
      { count: 6, label: 'Very Rare; Parapsychic Abilities', scale: 'overload', verbatim: 'A very rare sign. In the current century, this was only possible for those born in 1988. Children born with this sign had developed abilities and a penchant for studying the exact sciences. Such people often have parapsychic or extrasensory abilities. Four eights dominate and may suppress other qualities.' }
    ]
  },
  9: {
    digit: 9,
    ...
    meanings: [
      { count: 0, label: 'No Memory / Intellect', verbatim: 'There are no nines — weak level of mental ability. For a person who doesn\'t have either a 5 or a 9, doing science becomes a problematic situation. The person doesn\'t hear others and has no logic.', scale: 'absent' },
      { count: 1, label: 'Very Weak Memory', verbatim: 'Very weak memory. The channel of communication with the subtle world, with the cosmos, is essentially closed at birth. Such a person is constantly busy with calculations, experiments, trying to predict further events.', scale: 'very-weak' },
      { count: 2, label: 'Memory / Intellect in Norm', verbatim: 'Having \'99\' in the square of Pythagoras would add another \'5\'. Having accumulated quite a lot of life experience, a person gradually begins to strengthen his logical capabilities at the expense of accumulated situational models.', scale: 'norm' },
      { count: 3, label: 'Strong Memory - Very Smart', verbatim: 'Strong memory, mind; very smart. Bored if not interested in what they are doing. Have good eloquence. Often see \'prophetic\' dreams; can predict the course of events; are usually quite good physionomists.', scale: 'special' },
      { count: 4, label: 'Erudite but Tough, Merciless', verbatim: 'People are erudite, but tough, merciless. Everything that is happening around is clear to them. They clearly see the causes and consequences of events. They possess what can only be called clairvoyance.', scale: 'strong' },
      { count: 5, label: 'Complete Cosmic Memory', verbatim: 'Five 9\'s represents a complete cosmic memory — the person seems to carry within them the full record of everything they have experienced across time. The shadow is that this person may be living more in the accumulated past than in the present moment.', scale: 'dominant' },
      { count: 6, label: 'Memory Overload - Cognitive Burden', verbatim: 'Six or more 9\'s triggers the memory overload. The vast archive becomes a prison. The person cannot escape the weight of what they know and remember. Decision-making paradoxically slows.', scale: 'overload' }
    ]
  }
};
