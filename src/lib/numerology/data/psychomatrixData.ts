...
const CHAR_1_VERBATIM = `One. Character
...
const EN_2_NONE = `The absence of the number two in a psychomatrix indicates very low energy levels. Such individuals might be described as "vampires"—though one should not be alarmed by this term.
...
const EN_22 = `If your psychomatrix contains two "twos," you can consider yourself fortunate. This represents the standard—the baseline level of energy essential for every human being—signifying that you possess a healthy energy reserve that is highly conducive to interacting with others and performing work.
...
const EN_222 = `If you have "222" in your psychomatrix, it signifies that you possess the mark of an "extrasensory person" from birth—or, simply put, you are an extrasensory individual.
...
const EN_2222 = `If your psychomatrix contains four or more "2s," it signifies that you are a "donor"—a person possessing an excess of energy that you are free to expend as you see fit.
...
const INTER_3_ABSENT = `The absence of the number 3 in a psychomatrix signifies a person's natural inclination toward the humanities and the arts.
...
const INTER_33 = `Your psychomatrix contains two 3s; this indicates that you have an interest in the exact sciences and technology, but it does not necessarily mean that you are equipped to confidently pursue these fields.
...
const INTER_3333_AND_MORE = `In our time, this is a rather rare sign, though it does appear occasionally. It signifies a profound interest in science and technology. One could say that such a person is born to be an inventor or a designer.
...
By fortifying your health, you empower yourself to set and pursue loftier goals. You will find it easier to provide for your family, as you will possess the necessary physical stamina to perform your work effectively. Health can also be strengthened through the "conversion" of other numbers within your matrix: specifically, when an "11" converts into an "8" (yielding an additional "4"), or when a "6" converts into a "7" (yielding an additional "4"). To facilitate this conversion, you must cultivate the virtue of tolerance within yourself or actively engage in the arts. However, be careful not to con-flate genuine artistic engagement—driven by a child's own intrinsic interest—with activities (such as music lessons) that parents impose upon a child, demanding genius-level proficiency simply because they have paid for the instruction.`;

const HEALTH_4 = `If your psychomatrix contains exactly one instance of the number 4, it indicates that you were born with a baseline level of health; however, this constitution is not sufficiently robust to warrant neglecting preventive care or health maintenance.
...
const HEALTH_44_OR_MORE = `If your psychomatrix contains two or more fours, it signifies that you have been endowed with robust health from birth—and, along with it, a beautiful, strong physique.
...
const GROUNDING_6_FACTOR = `The presence of a single number 6 in a psychomatrix indicates that an individual engages in physical labor only when the mood strikes—that is, whenever the desire arises.
...
const GROUNDING_66_TRAIT = `The "66" sign is known as "Golden Hands," for a person possessing it is capable of doing anything—they are a master of any craft involving manual labor. It is precisely from such individuals that great architects and builders emerge.
...
const GROUNDING_666_AND_BEYOND = `We have now arrived at the biblical "Number of the Beast"—666—or, as it is otherwise known, the "Number of Satan." A greater number of sixes can be termed the "Number of the Sorcerer or Witch"—an even more potent sign.
...
The fact is that, having a weak-willed character, they avoid making any decisions, trying to shift them to someone else.
Escaping from making a decision, they desperately feign action and strenuously demonstrate their strong-willed qualities.
This is why they always get into arguments about any issue. Surprisingly, they are completely Fleming to the subject of the dispute, as in the argument itself, they are only interested in winning; they desperately need success, striving to demonstrate their strength of character to everyone.
They often become selfish in their pursuit of victory, ignoring other people with their requests and troubles. Such people never make hasty decisions and give complex answers that can be interpreted in different ways, allowing them to retract their statements or, even better, make no decisions at all.
Don't even think of accusing them of lack of willpower: you'll offend them, and they simply won't believe you, once again displaying their argumentative nature.
However, it's not all bad. They make the most wonderful deputies – deputies who are the "number two" behind the boss.
...
However, don't overpraise if your child has a score of 88 or 55 – they won't tolerate lies because they are "truth-seekers."`, scale: 'norm' },
      { count: 3, label: '"111" personality type', verbatim: `"111" personality type
...
Remember the words of Alexander Green: "Never do something you'll regret later." If you give in to someone out of pity, you'll explode later. The pity fades, and disappointment sets in, regretting what you've done.`, scale: 'special' },
      { count: 4, label: '"1111" personality type', verbatim: `"1111" personality type
...
Your personality gives you everything: tolerance, determination, self-esteem, and firmness. It's unlikely anyone can hinder you, but you can become an obstacle to yourself.`, scale: 'strong' },
      { count: 5, label: 'The "11111" personality type', verbatim: `The "11111" personality type
...
Being a despot is difficult. However, you can't blame someone for being born a despot. There are always reasons for this, rooted in their parents and their family history. If this happens, it's necessary to step away from power, finding yourself in creativity and developing your talent.`, scale: 'dominant' },
      { count: 6, label: 'Characters "111111 and More"', verbatim: `Characters "111111 and More"
...
It's essential to recognize their talent and carefully protect it from offense. Remember, even a single word or glance is enough to make them drop everything and be forever free of resentment.`, scale: 'overload' }
    ]
  },
  2: {
    digit: 2,
...
The energy of Number 2 also characterizes compatibility through energy contact. Questions of vampirism and donorship are always about Number 2 energy. In any conversation, one person takes the position of the donor and the other the vampire. The donor is the one who starts speaking about the interests of the other. The one who is in the center of the conversation (or brings up his own interests) becomes the vampire. A transition from '22' to '4' is also possible: physically perfect and beautiful people always draw attention to themselves — their contact energy (Number 2) comes from their healthy body, and if they are not aggressive and are quiet and kind, they can attract others.`,
    ...
    meanings: [
      ...
      { count: 4, label: 'Energy Profile: "2222 and Above"', verbatim: EN_2222, scale: 'strong' },
      { count: 5, label: 'Energy Profile: "2222 and Above"', verbatim: EN_2222, scale: 'dominant' },
      { count: 6, label: 'Energy Profile: "2222 and Above"', verbatim: EN_2222, scale: 'overload' }
    ]
  },
  3: {
    digit: 3,
  ...
  5: {
    ...
    meanings: [
      ...
      { count: 3, label: '"555 and Beyond" Logic', verbatim: LOGIC_555_AND_BEYOND, scale: 'special' },
      { count: 4, label: '"555 and Beyond" Logic', verbatim: LOGIC_555_AND_BEYOND, scale: 'strong' },
      { count: 5, label: '"555 and Beyond" Logic', verbatim: LOGIC_555_AND_BEYOND, scale: 'dominant' },
      { count: 6, label: '"555 and Beyond" Logic', verbatim: LOGIC_555_AND_BEYOND, scale: 'overload' }
    ]
  },
  6: {
    digit: 6,
