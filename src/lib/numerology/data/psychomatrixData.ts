...
const HEALTH_44 = `If your psychomatrix contains two or more fours, it signifies that you have been endowed with robust health from birth—and, along with it, a beautiful, strong physique.
...
const LOGIC_555 = `In the psychomatrix, the presence of three fives significantly attenuates one's logical faculties, rendering the manifestation of logic more of a sporadic occurrence—a surprise—than a consistent, predictable pattern. In this instance, these numbers are almost entirely overshadowed by the Line of Family Provision (for men) or the Line of Family (for women). At certain moments, the quality of "clear-knowing" may manifest; however, because the scope of their vision is so vast, the individual often struggles to believe in their own insights—a skepticism that renders their predictions seemingly implausible.
...
const GROUNDING_6_ABSENT = `If the number 6 is absent from a person's psychomatrix, it indicates that they are not inclined toward physical labor; they do not enjoy it and undertake it only out of necessity or a sense of duty toward another person.
...
const GROUNDING_6 = `The presence of a single number 6 in a psychomatrix indicates that an individual engages in physical labor only when the mood strikes—that is, whenever the desire arises.
...
const GROUNDING_66 = `The "66" sign is known as "Golden Hands," for a person possessing it is capable of doing anything—they are a master of any craft involving manual labor. It is precisely from such individuals that great architects and builders emerge.
...
const GROUNDING_666 = `We have now arrived at the biblical "Number of the Beast"—666—or, as it is otherwise known, the "Number of Satan." A greater number of sixes can be termed the "Number of the Sorcerer or Witch"—an even more potent sign.
...
It must be noted that after giving birth, any woman will experience a depletion of her energy reserves; this inevitably leads to a shift in her interests and goals, meaning that her passion for complex academic disciplines may wane—regardless of whether or not her husband actively supports her personal development. I believe it is precisely for this purely physiological reason that men generally have a greater opportunity to fully realize their potential than women do. Thus, I offer but one piece of advice to the ladies: do not delay—make haste.`,
  ...
  4: {
    ...
    meanings: [
      ...
      { count: 2, label: 'Health: "44 or More"', verbatim: HEALTH_44, scale: 'norm' },
      { count: 3, label: 'Health: "44 or More"', verbatim: HEALTH_44, scale: 'special' },
      { count: 4, label: 'Health: "44 or More"', verbatim: HEALTH_44, scale: 'strong' },
      { count: 5, label: 'Health: "44 or More"', verbatim: HEALTH_44, scale: 'dominant' },
      { count: 6, label: 'Health: "44 or More"', verbatim: HEALTH_44, scale: 'overload' }
    ]
  },
  5: {
    digit: 5,
    ...
    meanings: [
      ...
      { count: 3, label: '"555 and Beyond" Logic', verbatim: LOGIC_555, scale: 'special' },
      { count: 4, label: '"555 and Beyond" Logic', verbatim: LOGIC_555, scale: 'strong' },
      { count: 5, label: '"555 and Beyond" Logic', verbatim: LOGIC_555, scale: 'dominant' },
      { count: 6, label: '"555 and Beyond" Logic', verbatim: LOGIC_555, scale: 'overload' }
    ]
  },
  6: {
    digit: 6,
    ...
    meanings: [
      ...
      { count: 1, label: 'Labor: The "6" Factor', verbatim: GROUNDING_6, scale: 'very-weak' },
      { count: 2, label: 'The "66" Trait: Work', verbatim: GROUNDING_66, scale: 'norm' },
      { count: 3, label: 'Grounding: "666 and Beyond"', verbatim: GROUNDING_666, scale: 'special' },
      { count: 4, label: 'Grounding: "666 and Beyond"', verbatim: GROUNDING_666, scale: 'strong' },
      { count: 5, label: 'Grounding: "666 and Beyond"', verbatim: GROUNDING_666, scale: 'dominant' },
      { count: 6, label: 'Grounding: "666 and Beyond"', verbatim: GROUNDING_666, scale: 'overload' }
    ]
  },
  7: {
    digit: 7,
