...
export const PERSONAL_YEARS: PersonalYearInfo[] = [
  {
    ...
    desc: "Personal Year 1 stands at the cycle's threshold — the undifferentiated source from which all subsequent manifestation proceeds. This is the spring equinox moment: seed planted, potential activated, direction established. The seed you plant now contains the genetic information for the entire nine-year cycle. All subsequent years' themes are latent in Year 1's initiating gesture, making this year's choices particularly consequential even when their full significance won't become apparent until later."
  },
  {
    n: 2,
    ...
    desc: "Personal Year 2 represents late spring's germination phase — the critical period when the seed coat breaks, roots descend, and vulnerability is maximal. Above ground, little may be visible; below, transformative processes proceed invisibly."
  },
  {
    n: 3,
    name: 'Expression & Joy',
    ...
    desc: "Personal Year 3 completes spring with blossoming — the visible expression of prior cultivation. This year's energy is expansive, joyful, and creatively fertile. Social connections multiply, artistic output flourishes, and communication becomes your primary instrument."
  },
  {
    n: 4,
    ...
    desc: "Personal Year 4 is the cycle's first trough — and the most structurally important year most people barely notice it is. This corresponds to midsummer's demanding conditions: fruit-setting requires consistent effort, systems must support growth, and foundations are tested by heat and pressure."
  },
  {
    n: 5,
    name: 'Freedom & Change',
    ...
    desc: "Personal Year 5 is the cycle's pivot point — the dynamic centre where late summer's variability arrives and harvest approaches but weather remains unpredictable. This year's energy is dynamic, change-oriented, and freedom-seeking."
  },
  {
    n: 6,
    ...
    desc: "Personal Year 6 is early autumn's moment of sharing abundance — harvest distributed, responsibilities embraced, harmony restored. This year's energy is nurturing, service-oriented, and relationally focused."
  },
  {
    n: 7,
    name: 'Inner Retreat',
    ...
    desc: "Personal Year 7 is the cycle's second trough — the year the world goes quiet, or at least the year you need it to. Mid-autumn's introspective mood arrives: days shorten, attention withdraws from external achievement to internal processing."
  },
  {
    n: 8,
    name: 'Material Power',
    ...
    desc: "Personal Year 8 is late autumn's final productive surge — last harvest, accounting, preparation for winter. This year's energy is powerful, materially focused, and karmically active. Responsibility increases, demanding ethical integrity."
  },
  {
    n: 9,
    ...
    spirit: 'The ennead in Pythagorean philosophy contains all other numbers within itself. Year 9 is completion as wholeness — not the end of something, but the return of the seed to soil.',
    desc: "Personal Year 9 is the great clearing — winter solstice, when the cycle completes and the seed returns to soil. The year's energy is compassionate, transcendent, and releasing. projects conclude, relationships complete their purpose, outgrown patterns dissolve."
  },
];
