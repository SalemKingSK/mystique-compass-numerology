/**
 * @fileOverview Verbatim definitions for Personal Years, sync with YD in oracle.ts.
 */
...
Well-placed Saturn (Capricorn, Aquarius, Libra natally — especially exalted in Libra) produces extraordinary Year 8 achievement: genuine advancement, lasting recognition from those whose recognition genuinely matters, and the deeply satisfying experience of having built something real that serves beyond the self.`,
