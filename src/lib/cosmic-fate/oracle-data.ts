/**
 * @fileOverview Verbatim definitions for Personal Years, Pinnacles, and Challenges.
 */
...
export const CONVERGENCE_CARDS = [
  ...
  },
  {
    ...
    chips: [
      ...
      { t: "Life Path 1 in PY 7", p: "LP 1's pioneer identity — built on visible action, leadership, and initiating — dissolves in Year 7's interior fog. The self that knew how to begin finds no path to begin. This is not failure but preparation: Year 7 strips the warrior to the mystic, dismantling ego-scaffolding so Year 8's true authority can emerge from inner knowing rather than outer performance." },
...
export const CHALLENGE_DESC: Record<number, string> = {
