...
export const SECONDARY_ARROW_DEFINITIONS: ArrowDefinition[] = [
  {
    id: "prosperity",
    name: "The Arrow of Willpower",
    numbers: [4, 5, 6],
    type: "diagonal",
    state: "full",
    isPrimary: true,
    coreTrait: "The Golden Yog: a mark of rare alignment between discipline, internal power, and responsibility.",
    potentialTitle: "The Guardian Leader",
    potentialBody: "Widely considered the luckiest configuration in the grid, this 'Golden Yog' brings name, fame, and abundance. It balances logic, self, and responsibility in a perfect circuit.\n\n* **Deep Dive**: This represents the perfect flow between the Wood (4), Earth (5), and Metal (6) elements. The potential is 'Benign Authority.' These are natural-born leaders who lead through loyalty and security. They don't just achieve success; they create a 'Success Field' that protects and uplifts everyone in their orbit. They have a rare sense of moral duty, ensuring that their growth never comes at the expense of their integrity.",
  ...
  },
  {
    ...
    name: "The Arrow of Emotion",
    numbers: [2, 5, 8],
    type: "diagonal",
    state: "full",
    isPrimary: true,
    coreTrait: "The Property Yog: provides a profound internal shock-absorber and Silver resonance.",
    potentialTitle: "The Resilient Healer",
    potentialBody: "The 'Silver Yog' or 'Property Yog' grants exceptional emotional resilience and the ability to empathize with any point of view while remaining personally grounded.\n\n* **Deep Dive**: The light side is 'Alchemical Wisdom.' These individuals can take the 'lead' of emotional pain and transform it into the 'gold' of spiritual insight. They possess a magnetic stability that draws people and material resources (property/land) toward them. Their gift is the ability to provide a safe, stable emotional port in the midst of life's storms.",
    shadowTitle: "The Impenetrable Ice",
    shadowBody: "This 'Silver Yog' can become a 'Silver Prison.' The shadow side is 'emotional bypassing'—using balance as a shield against intimacy. The person becomes so 'balanced' that they appear robotic or unfeeling. They may use logic or spiritual concepts to avoid the messiness of true human connection. This creates a partner or friend who is 'perfect' on paper but impossible to reach emotionally; they offer a solution for every problem but never a shoulder to cry on.",
  },
];
